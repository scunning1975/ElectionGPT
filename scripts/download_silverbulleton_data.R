...
download_latest_data <- function() {
  ...
  destfile <- "data/expert/silverbulleton_predictions.csv"  # Specify the correct file path
...
download_latest_data <- function() {
  ...
  destfile <- "data/expert/silverbulleton_predictions2.csv"  # Specify the correct file path
  download.file(url, destfile)
  cat("File downloaded successfully:", destfile, "\n")
}
