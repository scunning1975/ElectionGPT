...
openai_api_key <- Sys.getenv("CONTROL_FOX")

# Define the prompt
prompt <- "Generate a short news story from the perspective of Fox News reporter Bret Baier about the outcome of the 2024 US presidential election between Donald Trump and Kamala Harris. The story must explicitly state the winner in each of the 50 states."
...
combined_story_filename <- paste0("story_Control_Fox_", timestamp, ".txt")
...
results_filename <- paste0("election_results_Control_Fox_", timestamp, ".xlsx")
