...
openai_api_key <- "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"
...
# Define the prompt
prompt <- "Given the recent news articles in the JSON data provided, generate a short news story from the perspective of Fox News reporter Bret Baier about the outcome of the 2024 US presidential election between Donald Trump and Kamala Harris. The story must explicitly state the winner in each of the 50 states.  Include a specifc detail or quote pulled directly from the news articles."
