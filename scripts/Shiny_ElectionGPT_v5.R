...
panel_data <- read.csv("/Users/jaredblack/KamalaGPT/news_data/election_news/panel_election_results_state.csv")
...
expert_opinions <- read.csv("/Users/jaredblack/KamalaGPT/news_data/Expert_Opinions.csv")
